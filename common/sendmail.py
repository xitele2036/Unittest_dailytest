...
# 测试报告的路径
reportPath = os.path.realpath("/dailytest/report/html")

# 配置收发件人
recvaddress = ['cji@creatcomm.com','cji@creatcomm.com']
# 用户名和密码
sendaddr_name = 'dailyregression@creatcomm.com'
sendaddr_pswd = 'CCtest654321'
